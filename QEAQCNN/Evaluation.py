...
class HybridEvaluator(Evaluator):
    ...
    def _create_observable(self, last_qubit: int, n_qubits: int = 16) -> SparsePauliOp:
    ...
    def evaluate(
        ...
        fm, input_params = self.feature_map_builder.build(self.builder.n_qubits)
        observable = self._create_observable(last_qubit, self.builder.n_qubits)
