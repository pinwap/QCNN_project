...
class AutoEvolutionPipeline:
    ...
    def run(self, x_train, y_train, x_test=None, y_test=None, x_val=None, y_val=None, checkpoint_dir=None, file_id=None):
        """
        ...
        final_score, training_history, trained_obj = production_pipeline.run(
            ...
            checkpoint_dir=checkpoint_dir, file_id=file_id
        )
